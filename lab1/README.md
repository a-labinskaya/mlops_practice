# Lab 1. Базовый ML-пайплайн

В этой лабораторной работе собран простой конвейер машинного обучения для классификации рукописных цифр из датасета `sklearn.datasets.load_digits`.
