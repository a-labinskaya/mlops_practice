# Lab 2. ML-пайплайн в Jenkins

Лабораторная работа развивает пайплайн из `lab1`: те же этапы подготовки данных, обучения и тестирования модели вынесены в Jenkins Pipeline для Linux и Windows окружений.
